...
export default function  CreateEmployee() {
    ...
    // Defining constraints for the fields
    ...
    const base_url = 'https://assignment02-101331806-deploy.herokuapp.com/api/emp/employees';
    ...
    return (
            <div>
                <div style={{marginTop:"40px", marginBottom:"50px"}} className="row">
